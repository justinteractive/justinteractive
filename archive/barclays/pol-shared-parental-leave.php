...
<html class="no-js" lang="">
    ...
    <body id="bootstrap-override">
        ...
        <div id="app-container">
            ...
            <div class="jumbotron hero hero-shared-parental-leave">
                ...
                <div class="container">
                    <blockquote>
                        <h1>Shared parental leave</h1>
                        <h2>Shared Parental Leave enables parents to share the care of their child during the first year of the child's life</h2>
                    </blockquote>
                    <div class="actions">
                        <button class="btn btn-primary btn-barclays" type="button">Book leave now</button>
            ...
            <div class="subnav">
                <div class="container">
                    <ul class="row">
                        <li class="col">Option 1</li>
                        <li class="col">Option 2</li>
                        <li class="col">Option 3</li>
                        <li class="col">Option 4</li>
                        <li class="col">Option 5</li>
                    </ul>
                </div>
            </div>
