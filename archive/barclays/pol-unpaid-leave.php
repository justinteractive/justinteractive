...
<html class="no-js" lang="">
    <head>
        ...
        <title>Barclays myHR - Time Off - Unpaid Leave</title>
    ...
    <body id="bootstrap-override">
        ...
        <div id="app-container">
            ...
            <div class="jumbotron hero hero-annual-leave">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Unpaid leave</li>
                    </ol>
                </nav>
                ...
                <div class="container">
                    <blockquote>
                        <h1>Unpaid leave</h1>
                        <h2>Unpaid leave enables eligible Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</h2>
                    </blockquote>
                    <div class="actions">
                        <a class="btn btn-primary btn-barclays">Book leave now</a>
            ...
            <div class="container text-center component-key-highlights">
                ...
                <ul class="row">
                    <li class="col">
                        ...
                        <h3>Time Off</h3>
                        <p>Two weeks leave for each birth or adoption that can be taken as one or two weeks’ consecutive leave</p>
                    </li>
                    <li class="col">
                        <div class="icon" style="background-image:url(img/icons/icon-pay.png);"></div>
                        <h3>Pay</h3>
                        <p>Two weeks of salary, the first of which paid at your normal rate and the second one paid at the UK Statutory Rate</p>
                    </li>
                    <li class="col">
                        <div class="icon" style="background-image:url(img/icons/icon-fat-arrow.png);"></div>
                        <h3>Extra transitional days</h3>
                        <p>Up to 10 extra paid transitional days within the first 2 years of your return from paternity leave </p>
                    </li>
                </ul>
            </div>
            ...
            <div class="container text-center">
                ...
                <div class="divider-horz"></div>
                <img src="img/components/policy-paternity-leave-eligibility-entitlements.png">
            </div>

            <div class="container text-center">
                <h1>How to take paternity leave</h1>
                <div class="divider-horz"></div>
                <img src="img/components/policy-paternity-leave-how-to.png">
            </div>
            ...
            <div class="container component-further-information">
                ...
                <div class="card-deck text-left">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">Dealing with loss</h3>
            ...
            <div class="container">
                <div class="text-center">
                    <h1 data-toggle="tooltip" title="Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Nulla vitae elit libero, a pharetra augue. Aenean lacinia bibendum nulla sed consectetur. Maecenas sed diam eget risus varius blandit sit amet non magna. Donec ullamcorper nulla non metus auctor fringilla. Maecenas faucibus mollis interdum. Etiam porta sem malesuada magna mollis euismod.">Document downloads</h1>
                    <div class="divider-horz"></div>
                    <img src="img/components/policy-paternity-leave-document-downloads.png">
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="card-deck text-left">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Career breaks</h3>
                        ...
                        <div class="card-footer">
                            <button class="btn btn-primary btn-barclays" type="button">View more info</button>
                        </div>
                    </div>
                    <div class="card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Buy and sell holiday</h3>
                        ...
                        <div class="card-footer">
                            <button class="btn btn-primary btn-barclays" type="button">Visit the site</button>
                        </div>
                    </div>
                </div>
            </div>
